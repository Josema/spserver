...
require_once('IPCounter.php');
require_once('rooms/Room.php');
require_once('rooms/Rooms.php');
require_once('sockets/Socket.php');
require_once('sockets/CommandSocket.php');
require_once('sockets/AdminSocket.php');
require_once('sockets/ListenerSocket.php');
require_once('sockets/AccountSocket.php');
require_once('sockets/UserSocket.php');
require_once('sockets/LocalQuerySocket.php');
require_once('sockets/RemoteQuerySocket.php');
require_once('sockets/PolicySocket.php');
...
class BlossomServer {
	...
	public function start() {
		...
		$this->set_interval($this, 'sendtest', 5);
	...
	public function sendtest() {
	   echo 123;
		socket_write($this->mysoc, 'PROBANDO');
	}
}
