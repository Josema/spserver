...
class Server extends EventDispatcher
{
	...
	public function start()
	{
		while ($this->running)
		{
			...
			// una vez que reciba algo continuar� el script y el array $listening que se pas� por parametro contendra unicamente los 
			...
			// har� que continue el bucle de igual forma aunque no hayan actualizaciones en los $listeners.
